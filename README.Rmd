...
_Maybe you're born with it_ but I found dealing with different types of issues in shiny apps difficult, so
wrote this package to facilitate easier processing of different types of issues.
With {conditionR},
